namespace _09Day_LinQ4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //// This behaviour of LINQ , where LINQ query gets fired when you strat using it is known as :
            //// LAZY LOADING OF LINQ or Delayed Excecution of LINQ Query
            ...
            //// LINQ Query gets fired when you start using .ToList() method [In case of LINQ if we would have not used the list function then it would have been executed when we have used it like when we are using it to print]
            //var result = (from emp in emps
            //              where emp.Address.ToLower().StartsWith(city)
            ...
            #region Linq with Holder
            //Console.WriteLine("Enter the City Starting character");
